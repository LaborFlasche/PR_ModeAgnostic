...
CONFIG = sys.argv[1]
# NN configs run through run_benchmark_nn.py, which indexes build_all_runs_nn —
# same filename convention as submit.sh / select_array_script.sh.
build_fn = build_all_runs_nn if "neural-networks" in os.path.basename(CONFIG) else build_all_runs
